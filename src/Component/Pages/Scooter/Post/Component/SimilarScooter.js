...
const SimilarScooter = (props) => {
  ...
  const showData = [
    {
      id: 1,
      value: scooter.filter(
        (item) => item.scootername === valData.similarScooter[0]
      ),
    },
    {
      id: 2,
      value: scooter.filter(
        (item) => item.scootername === valData.similarScooter[1]
      ),
    },
    {
      id: 3,
      value: scooter.filter(
        (item) => item.scootername === valData.similarScooter[2]
      ),
    },
  ];
  return (
              ...
              <div className="row d-flex justify-content-center ">
                ...
                {showData.map((item) => {
                  return (
                    <>
                      <div
                        className="col-lg-4 col-md-6 d-flex mt-3 justify-content-center   text-center"
                        key={item.id}
                      >
                        <div
                        ...
                        >
                          <img
                            src={item.value[0].image}
                            className="card-img-top "
                            alt={item.value[0].company}
                            style={{
                              height: "200px",
                            }}
                          />
