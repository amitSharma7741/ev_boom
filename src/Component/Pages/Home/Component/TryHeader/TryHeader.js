                    ...
                    <div className="inner-header flex">
                        ...
                        <div className="position-absolute" style={{
                            ...
                            <Player
                                autoplay
                                loop
                                src="https://assets4.lottiefiles.com/packages/lf20_vuubgscl.json"
                                // src="https://assets2.lottiefiles.com/packages/lf20_6TkCyn.json"
                                style={{
                                    height: '80px',
                                    width: '80px',
                                    borderRadius: "50%",
                    ...
                    <div>
                        <svg className="waves" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 24 150 28" preserveAspectRatio="none" shapeRendering="auto">
                            ...
                            <g className="parallax">
                                ...
                                <use xlinkHref="#gentle-wave" x={48} y={5} fill="rgba(106, 90, 205,0.3)" />
                                <use xlinkHref="#gentle-wave" x={48} y={7} fill="rgb(240, 240, 240)" />
                            </g>
                        </svg>
                    </div>
                    {/*Waves end*/}
